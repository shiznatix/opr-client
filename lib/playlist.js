...
module.exports = {
	...
	setAt: function(filePaths, atIndex) {
		const self = this,
	...
	playAt: function(index) {
		...
		return new Promise((accept, reject) => {
			...
			// TODO run the actual omxplayer command here
